    ...
    <>
      <main className="relative w-full min-h-screen">
          ...
          <div className="global-container">
            <div className="text-center mb-12">
              ...
              <p className="text-[#64748B] md:text-lg text-base font-light mt-3 max-w-2xl mx-auto">
                Millions of travelers trust PikPakGo for transparent pricing,
                real reviews, and zero hidden fees.
              </p>
            </div>
        ...
        <section className="py-20 bg-white">
          <div className="global-container">
            ...
            <div className="grid md:grid-cols-4 grid-cols-2 gap-5">
              {categories.map(({ label, desc, icon: Icon, href, image, color }) => (
        ...
        <section className="bg-white md:hidden block">
          <div className="global-container">
            <Image src={BGOne} alt="AI Trip Planner" className="md:hidden block" />
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 items-center justify-between">
              <div>
                ...
                <p className="text-[#475569] 2xl:text-xl md:text-base text-sm font-light mt-4">
                  ...
                  white-label portal to manage bookings, markups, and
                  commissions in one dashboard.
                </p>
                <div className="pt-8">
        ...
        <section className="relative text-white md:block hidden">
          <div className="relative">
            <Image src={SectionBG} alt="List your property" className="w-full h-auto" />
          </div>
        ...
        <section className="relative text-white md:hidden block">
          <div className="global-container relative">
            <div className="relative">
              <Image src={Imag1} alt="List your property" className="w-full h-auto rounded-md" />
            </div>
          </div>
        </section>
