...
export const Modal = ({ isOpen, onClose, title, children, width, footerBtnText, zIndex, showFooter = true, onConfirm }: ModalProps) => {
  ...
  return (
    <div
      className={`fixed inset-0  bg-opacity-10 flex items-center justify-center p-4  animate-fadeIn backdrop-blur-sm ${zIndex === true ? 'z-[9999]' : 'z-50'}`}
      // onClick={onClose}
    >
      <div
        ...
        {showFooter && (
          <div className="flex gap-3 p-6 border-t border-gray-200">
            ...
            <button
              ...
              className="flex-1 bg-[#16A34A] text-white px-4 py-2 rounded-lg font-medium hover:shadow-lg transform hover:scale-105 transition-all duration-200"
            >
